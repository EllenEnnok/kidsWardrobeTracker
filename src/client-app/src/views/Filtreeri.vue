<template>
  <div class="filtreeri">
    ...
    <select v-model="filter.kategooriaId">
      <option :value="null">----</option>
      <option :key="kategooria.id" v-for="kategooria in klassifikaatorid.kategooriad" :value="kategooria.id">{{kategooria.nimetus}}</option>
    </select>
    <br>
    <br>
    ...
    <option :value="null">----</option>
      <option :key="suurusJalatsid.id" v-for="suurusJalatsid in klassifikaatorid.suurus_jalatsid" :value="suurusJalatsid.id">{{suurusJalatsid.nimetus}}</option>
    ...
    <select v-model="filter.suurusRiidedId" >
      <option :value="null">----</option>
      <option :key="suurusRiided.id" v-for="suurusRiided in klassifikaatorid.suurus_riided" :value="suurusRiided.id">{{suurusRiided.nimetus}}</option>
    ...
    <select v-model="filter.hooaegId">
      <option :value="null">----</option>
      <option :key="hooaeg.id" v-for="hooaeg in klassifikaatorid.hooajad" :value="hooaeg.id">{{hooaeg.nimetus}}</option>
    ...
    <select v-model="filter.materjalId">
      <option :value="null">----</option>
      <option :key="materjal.id" v-for="materjal in klassifikaatorid.materjalid" :value="materjal.id">{{materjal.nimetus}}</option>
    </select>
    ...
    <select v-model="filter.asukohtId">
      <option :value="null">----</option>
      <option :key="asukoht.id" v-for="asukoht in klassifikaatorid.asukohad" :value="asukoht.id">{{asukoht.nimetus}}</option>
    </select>
    <input placeholder="Lisa uus asukoht" v-model="Asukoht.asukoht"> <button v-on:click="lisaAsukoht()">Lisa</button>
    <br>
    <br>

    <br>
    <button @click="uuendaKapp">Filtreeri</button>
    <div v-for="ese in esemed" :key="ese.id">
      <h1>{{ ese.id }}</h1>
