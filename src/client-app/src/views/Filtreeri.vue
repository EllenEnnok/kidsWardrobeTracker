<template>
  <div class="filtreeri">
    ...
    <select name="oueriided" id="oueriided">
      ...
      <option value="2">Joped</option>
      <option value="3">Kombekad</option>
      <option value="4">Õuepüksid</option>
    </select>
    <br>
    <br>
    <input type="checkbox">
    ...
    <select name="oueriided" id="oueriided">
      <option value="1"></option>
      <option value="2">Lühikese varrukaga särgid</option>
      <option value="3">Pika varrukaga särgid</option>
      <option value="4">Lühikesed püksid</option>
      <option value="4">Pikad püksid</option>
      <option value="4">Aluspesu</option>
    </select>
    <br>
    <br>
    <input type="checkbox">
    <label>Aksessuaarid</label>
    <select name="aksessuaarid" id="aksessuaarid">
      <option value="1"></option>
      <option value="2">Mütsid</option>
      <option value="3">Sallid</option>
      <option value="4">Kindad</option>
    </select>
    <br>
    <br>
    <input type="checkbox">
    <label>Jalanõud</label>
    <br>
    <br>
    <input type="checkbox">
    <label>Spordiriided</label>
    <select name="spordiriided" id="spordiriided">
      <option value="1"></option>
      <option value="2">Lühikese varrukaga särgid</option>
      <option value="3">Pika varrukaga särgid</option>
      <option value="4">Lühikesed püksid</option>
      <option value="3">Pikad püksid</option>
      <option value="4">Ujumisriided</option>
    </select>
    <br>
    <br>
    <input type="checkbox">
    ...
    <input type="checkbox">
    <label>Asukoht</label>
    <select name="asukoht" id="asukoht">
      <option value="1"></option>
    </select>
    <br>
    <br>
